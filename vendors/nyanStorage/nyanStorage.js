function nyanStorageConstructor() {
...
nyanStorageConstructor.prototype.api = function() {
	console.log("APIIII");

	return this;
}
nyanStorageConstructor.prototype.isAvailable = function(key) {
	return (localStorage.getItem(key) == null) ? false : true;
}
nyanStorageConstructor.prototype.get = function(key) {
...
nyanStorageConstructor.prototype.put = function(key, data) {
	var content;
...
nyanStorageConstructor.prototype.remove = function(key) {
	localStorage.removeItem(key);
}
nyanStorageConstructor.prototype.getAll = function() {
...
nyanStorageConstructor.prototype.clear = function() {
